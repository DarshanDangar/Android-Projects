...
public class Tvssss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Tvssss.this));
        ...
        parrayList.add(new ListModel(productNameArray[1], productPriceArray[1], productDescriptionArray[1], productImageArray[1]));
