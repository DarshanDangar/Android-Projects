...
public class Tablet extends AppCompatActivity {
    ...
    String[] productNameArray = {"Apple Smartwatch", "Dell Laptop", "iphone 13Pro max", "Nothinng Phone", "Ipad 7"};
    int[] productImageArray = {R.drawable.apple_smartwatch, R.drawable.dell_inspirion_15, R.drawable.iphone13, R.drawable.nothing_phone_1, R.drawable.ipad};
    String[] productPriceArray = {"35,000", "55,000", "1,10,000", "33,000", "50000"};
    String[] productDescriptionArray = {"Big screen. Huge impact. The challenge was to create a bigger display while barely expanding the dimensions of the watch itself. To do so, the display was completely re‑engineered reducing the borders by 40%, allowing for more screen area than both Series 6 and Series 3. Now that’s something to smile about.",
            ...
            "Retina display.\n" +
                    ...
                    "2160-by-1620-pixel resolution at 264 pixel per inch (ppi)\n" +
                    "500 nits brightness.\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Tablet.this));
        ...
        parrayList.add(new ListModel(productNameArray[4], productPriceArray[4], productDescriptionArray[4], productImageArray[4]));
