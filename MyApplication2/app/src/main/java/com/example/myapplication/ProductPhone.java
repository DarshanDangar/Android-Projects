...
public class ProductPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ProductPhone.this));
        ...
        parrayList.add(new ListModel(productNameArray[2], productPriceArray[2], productDescriptionArray[2], productImageArray[2]));
